# cross-workspace-conflicts Specification

## Purpose
Define Locus's conflict-visibility and explicit deep-check contract for sibling Workspaces in the
Agent Workbench, including status-derived overlap, bounded hunk and committed-tree adjudication,
honest degradation and staleness, and no added Git-subprocess cost on the polling path.
